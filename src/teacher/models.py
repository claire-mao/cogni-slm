...
MODEL_PRICING_USD_PER_MILLION: dict[str, ModelPricing] = {
    ...
    "claude_opus_4_8": ModelPricing(input_per_million=15.0, output_per_million=75.0),
    "claude_sonnet_4": ModelPricing(input_per_million=3.0, output_per_million=15.0),
    "gemini_3_1_pro": ModelPricing(input_per_million=1.25, output_per_million=10.0),
