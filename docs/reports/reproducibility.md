...
- Generated: `2026-07-09 09:58:53`
- One-command entry point: `make dataset-build`
- Total runtime (seconds): `17.91`
...
|---:|---|---|---:|---|
| 1 | verify raw datasets | PASS | 0.16 | files=8, rows=40720, malformed=0, failures=0 |
| 2 | ingest Hugging Face datasets | WARN | 1.17 | download=skipped (--skip-download) / build: status=ok; output={ "raw_root": "datasets/raw", "output_dir": "datasets/hf/dataset_dict", "split_counts": { "train": 12964, "validation": 0, "test": 0 }, "stats": { "files_scanned": 7, "files_processed": 7, "rows_seen": 40744, "rows_kept": 12964, "rows_dropped_missing_text": 19278, "rows_dropped_missing_score": 8487, "rows_dropped_bad_score": 15, "parse_errors": 0 } } Saving the dataset (0/1 shards): 0%/ / 0/12964 [00:00<?, ? examples/s] Saving the dataset (1/1 shards): 100%/██████████/ 12964/12964 [00:00<00:00, 1080669.31 examples/s] Saving the dataset (1/1 shards): 100%/██████████/ 12964/12964 [00:00<00:00, 1046074.59 examples/s] |
| 3 | normalize schemas | PASS | 2.46 | status=ok; output={ "datasets_root": "datasets", "jsonl_cases": 0, "structured_file_cases": 12, "hf_dataset_dict_cases": 1, "total_cases": 13, "combined_rows": 54566, "output_root": "datasets/processed/unified", "combined_output": "datasets/processed/unified/unified_all.jsonl", "report_path": "docs/reports/schema_mapping.md" } |
| 4 | compute quality scores | PASS | 1.79 | total=53388, kept=32493, removed=20895, threshold=60.0 |
| 5 | deduplicate | PASS | 1.21 | input=32493, deduped=12413, final=12413, split_counts={'train': 9930, 'validation': 1241, 'test': 1242} |
| 6 | verify licenses | PASS | 0.08 | sources=1, open_or_verified=False |
| 7 | generate provenance | PASS | 8.66 | status=ok; output={ "records": 144015, "input_rows": 144015, "required_missing_counts": { "original_dataset": 0, "original_identifier": 0, "preprocessing_history": 0, "split_assignment": 0, "source_url": 0, "license": 0 }, "output_parquet": "datasets/final/provenance.parquet", "report_path": "docs/reports/provenance.md" } /Users/runner/work/crossbow/crossbow/arrow/cpp/src/arrow/util/cpu_info.cc:242: IOError: sysctlbyname failed for 'hw.l1dcachesize'. Detail: [errno 1] Operation not permitted /Users/runner/work/crossbow/crossbow/arrow/cpp/src/arrow/util/cpu_info.cc:242: IOError: sysctlbyname failed for 'hw.l2cachesize'. Detail: [errno 1] Operation not permitted /Users/runner/work/crossbow/crossbow/arrow/cpp/src/arrow/util/cpu_info.cc:242: IOError: sysctlbyname failed for 'hw.l3cachesize'. Detail: [errno 1] Operation not permitted /Users/runner/work/crossbow/crossbow/arrow/cpp/src/arrow/util/cpu_info.cc:242: IOError: sysctlbyname failed for 'hw.optional.neon'. Detail: [errno 1] Operation not permitted |
| 8 | build training dataset | PASS | 0.95 | status=ok; output={ "output_dataset_dir": "datasets/training", "provenance_dir": "datasets/training_provenance", "report_path": "docs/reports/training_dataset.md", "train": 9930, "validation": 1241, "test": 1242, "load_ok": true } Saving the dataset (0/1 shards): 0%/ / 0/9930 [00:00<?, ? examples/s] Saving the dataset (1/1 shards): 100%/██████████/ 9930/9930 [00:00<00:00, 2168563.92 examples/s] Saving the dataset (1/1 shards): 100%/██████████/ 9930/9930 [00:00<00:00, 2026539.45 examples/s] Saving the dataset (0/1 shards): 0%/ / 0/1241 [00:00<?, ? examples/s] Saving the dataset (1/1 shards): 100%/██████████/ 1241/1241 [00:00<00:00, 968036.31 examples/s] Saving the dataset (1/1 shards): 100%/██████████/ 1241/1241 [00:00<00:00, 843072.77 examples/s] Saving the dataset (0/1 shards): 0%/ / 0/1242 [00:00<?, ? examples/s] Saving the dataset (1/1 shards): 100%/██████████/ 1242/1242 [00:00<00:00, 938786.37 examples/s] Saving the dataset (1/1 shards): 100%/██████████/ 1242/1242 [00:00<00:00, 809152.78 examples/s] |
| 9 | verify final dataset | PASS | 1.25 | status=ok; output={ "report_path": "docs/reports/final_verification.md", "dataset_dir": "datasets/final", "hf_disk_path": "datasets/final/dataset_dict", "hf_ok": true, "id_overlap_train_test": 0, "text_overlap_train_test": 0, "prompt_overlap_train_test": 8 } Generating train split: 0 examples [00:00, ? examples/s] Generating train split: 9930 examples [00:00, 108974.89 examples/s] Generating validation split: 0 examples [00:00, ? examples/s] Generating validation split: 1241 examples [00:00, 97454.29 examples/s] Generating test split: 0 examples [00:00, ? examples/s] Generating test split: 1242 examples [00:00, 101577.99 examples/s] Saving the dataset (0/1 shards): 0%/ / 0/9930 [00:00<?, ? examples/s] Saving the dataset (1/1 shards): 100%/██████████/ 9930/9930 [00:00<00:00, 206579.07 examples/s] Saving the dataset (1/1 shards): 100%/██████████/ 9930/9930 [00:00<00:00, 205022.19 examples/s] Saving the dataset (0/1 shards): 0%/ / 0/1241 [00:00<?, ? examples/s] Saving the dataset (1/1 shards): 100%/██████████/ 1241/1241 [00:00<00:00, 129842.63 examples/s] Saving the dataset (1/1 shards): 100%/██████████/ 1241/1241 [00:00<00:00, 125685.31 examples/s] Saving the dataset (0/1 shards): 0%/ / 0/1242 [00:00<?, ? examples/s] Saving the dataset (1/1 shards): 100%/██████████/ 1242/1242 [00:00<00:00, 275873.83 examples/s] Saving the dataset (1/1 shards): 100%/██████████/ 1242/1242 [00:00<00:00, 263643.18 examples/s] |
| 10 | generate reports (dataset cards) | PASS | 0.18 | status=ok; output={ "generated_cards": [ "/Users/clairemao/Documents/cogni-slm/.rebuild_workspace/docs/datasets/dataset_cards/asap_aes.md", "/Users/clairemao/Documents/cogni-slm/.rebuild_workspace/docs/datasets/dataset_cards/persuade2.md", "/Users/clairemao/Documents/cogni-slm/.rebuild_workspace/docs/datasets/dataset_cards/asap2.md" ], "output_dir": "/Users/clairemao/Documents/cogni-slm/.rebuild_workspace/docs/datasets/dataset_cards", "count": 3 } |
